                ...
                <form action="<?= site_url('admin/produk/store') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select <?= $validation->hasError('category') ? 'is-invalid' : '' ?>" id="category" name="category" required>
                            ...
                            <option value="Lantai Vinyl" <?= old('category') == 'Lantai Vinyl' ? 'selected' : '' ?>>Lantai Vinyl</option>
                            <option value="Lantai Parket" <?= old('category') == 'Lantai Parket' ? 'selected' : '' ?>>Lantai Parket</option>
                            <option value="SPC Flooring" <?= old('category') == 'SPC Flooring' ? 'selected' : '' ?>>SPC Flooring</option>
                            <option value="Aksesoris Lantai" <?= old('category') == 'Aksesoris Lantai' ? 'selected' : '' ?>>Aksesoris Lantai</option>
                            <option value="Jasa Pemasangan" <?= old('category') == 'Jasa Pemasangan' ? 'selected' : '' ?>>Jasa Pemasangan</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Jelaskan spesifikasi teknis, ukuran, atau fitur lengkap produk.</div>
                    </div>
