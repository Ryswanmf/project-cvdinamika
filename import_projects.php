<?php
// Script untuk import data projects dari static ke database
...
// Data projects static yang akan diimport
$projects = [
    // KLINIK
    [
...
// Copy images dari public/img ke uploads/projects
...
foreach ($projects as $project) {
    ...
    if (file_exists($sourceFile)) {
        ...
        echo "✗ File not found: {$project['image']}\n";
    }
    ...
    try {
        ...
        echo "✗ Error: {$project['title']} - " . $e->getMessage() . "\n";
    }
...
echo "\n========================================\n";
echo "Import selesai!\n";
echo "Total data berhasil diimport: $imported dari " . count($projects) . " data\n";
echo "========================================\n";
echo "\nSekarang buka http://localhost:8080/portofolio untuk melihat hasilnya!\n";
echo "Dan buka http://localhost:8080/admin/projects untuk mengelola data.\n";
