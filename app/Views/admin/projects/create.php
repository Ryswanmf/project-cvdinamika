                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select <?= $validation->hasError('category') ? 'is-invalid' : '' ?>" id="category" name="category" required>
                                ...
                                <option value="Rumah Tinggal" <?= old('category') == 'Rumah Tinggal' ? 'selected' : '' ?>>Rumah Tinggal</option>
                                <option value="Kantor" <?= old('category') == 'Kantor' ? 'selected' : '' ?>>Kantor</option>
                                <option value="Komersial" <?= old('category') == 'Komersial' ? 'selected' : '' ?>>Komersial</option>
                                <option value="Renovasi" <?= old('category') == 'Renovasi' ? 'selected' : '' ?>>Renovasi</option>
                            </select>
